...
def generate_svg():
    ...
    for i in range(num_circles, 0, -1):
        ...
        r = int(36 + 152 * t)
        g = int(44 + 81 * (1.26 - t))
        b = int(174 + 42 * math.sin(t * math.pi))
    ...
    for i in range(0, num_lines, 2):
        ...
        for j in range(3, num_circles, 2):
            ...
            dx = cx + dot_r * math.cos(angle)
            dy = cy + dot_r * math.sin(angle)
            elements.append(f'<circle cx="{dx:.1f}" cy="{dy:.1f}" r="3.0" fill="#ccc6c2" fill-opacity="0.6"/>')
    for i in range(num_lines):
    ...
    for i in range(num_circles, 0, -1):
        ...
        r = int(31 + 318 * t)
        g = int(30 + 59 * (0.61 - t))
        b = int(232 + 65 * math.sin(t * math.pi))
        color = f'#{r:02x}{g:02x}{b:02x}'
