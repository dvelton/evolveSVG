...
![generation](https://img.shields.io/badge/generation-38-blue) ![fitness](https://img.shields.io/badge/fitness-85.79-brightgreen)
...
```
CCCS.ANANAEACAACSAECEECEANESEAENSEAAES
```
